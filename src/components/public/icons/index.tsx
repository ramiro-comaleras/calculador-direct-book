...
export function ServiceIcon({ icon, className }: { icon: string; className?: string }) {
  switch (icon) {
    case 'motor-reservas': return <DollarIcon className={className} />
    case 'ia-concierge': return <UsersGroupIcon className={className} />
    ...
    case 'domestic-violence': return <HomeIcon className={className} />
    case 'separation': return <HomeIcon className={className} />
...
export function ValueIcon({ icon, className }: { icon: string; className?: string }) {
  switch (icon) {
    ...
    case 'results': return <StarIcon className={className} />
    default: return <HomeIcon className={className} />
  }
}
