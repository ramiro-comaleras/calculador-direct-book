          ...
          <div>
            ...
            <h2 className="font-heading text-display-md md:text-display-lg text-gray-900 mb-6">
              <span className="text-body-sm text-teal-100">
                Servicio de reservas directas para hoteles en {siteConfig.contact.city}, {siteConfig.contact.country}
              </span>
            </h2>
            ...
            <Link
              href="/demo"
              title="El sistema que se paga solo recuperando tus comisiones."
